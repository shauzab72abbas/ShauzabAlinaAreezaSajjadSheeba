package com.ShauzabMomDadAlinaAriza.ShauzabPresentFamily;
...
@RestController()
public class AlinaDivorcedAmeenRestController {
@GetMapping("/shauzab")
